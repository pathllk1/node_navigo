      ...
      <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
        ...
        <div class="group relative p-8 rounded-3xl bg-white/70 backdrop-blur-xl 
          ...
          <div class="relative z-10">
            ...
            <p class="text-gray-500 mb-6">Track transactions and manage daily sales operations.</p>
            <a href="/inventory/sls" data-navigo class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-emerald-600 text-white font-medium shadow-md hover:bg-emerald-700 transition duration-300">Open Sales</a>
          </div>
        </div>
        ...
        <div class="group relative p-8 rounded-3xl bg-white/70 backdrop-blur-xl 
          ...
          <div class="relative z-10">
            ...
            <p class="text-gray-500 mb-6">Analyze performance and generate sales insights.</p>
            <a href="/inventory/sls/rpt" data-navigo class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-blue-600 text-white font-medium shadow-md hover:bg-blue-700 transition duration-300">View Reports</a>
          </div>
        </div>
        ...
        <div class="group relative p-8 rounded-3xl bg-white/70 backdrop-blur-xl 
          ...
          <div class="relative z-10">
            <div class="w-14 h-14 flex items-center justify-center rounded-2xl 
                        ...
                        text-white shadow-lg mb-6">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-7 h-7">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3 7.5l9-4.5 9 4.5M3 7.5v9l9 4.5 9-4.5v-9M12 3v18" />
              </svg>
            </div>
            <h2 class="text-xl font-semibold text-gray-900 mb-2">Stocks</h2>
            <p class="text-gray-500 mb-6">Monitor inventory levels and stock movement insights.</p>
            <a href="/inventory/sls/sts" data-navigo class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-orange-600 text-white font-medium shadow-md hover:bg-orange-700 transition duration-300">View Stocks</a>
          </div>
        </div>
        ...
        <div class="group relative p-8 rounded-3xl bg-white/70 backdrop-blur-xl 
          ...
          <div class="relative z-10">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-2">Movement</h2>
            <p class="text-gray-500 mb-6">Track stock transfers, inflows, and outflow history.</p>
            <a href="/inventory/sls/mov" data-navigo class="inline-flex items-center justify-center px-5 py-3 rounded-xl bg-purple-600 text-white font-medium shadow-md hover:bg-purple-700 transition duration-300">View Movement</a>
          </div>
        </div>
